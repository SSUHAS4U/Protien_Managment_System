...
export default function SignUp() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const existingUserResponse = await axios.get(`https://eloquent-mindfulness-production-5c03.up.railway.app/`);
      ...
      const response = await axios.post('https://eloquent-mindfulness-production-5c03.up.railway.app/', {
        name: formData.Name,
