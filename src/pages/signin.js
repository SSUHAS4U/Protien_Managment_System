...
export default function SignIn() {
  ...
  const generateCaptcha = async () => {
    try {
      const response = await fetch('https://eloquent-mindfulness-production-5c03.up.railway.app/captcha/generate');
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await fetch('https://eloquent-mindfulness-production-5c03.up.railway.app/users/login', {
        method: 'POST',
